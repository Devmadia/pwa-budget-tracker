...
function createTransactionForm() {
    ...
    // return false for invalid responses and display validation message
    const validate = () => {
        // validate form
    ...
    // return transaction object from the forms input
    const transaction = () => {
        return {
            name: nameEl.value,
...
function sendTransaction(isAdding) {
    ...
    // for subtracting funds, convert to negative number
    if (!isAdding) {
        transaction.value *= -1;
    }
    ...
    // re-run logic to populate with new record
    populateChart();
    populateTable();
    populateTotal();
